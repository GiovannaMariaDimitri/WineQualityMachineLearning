...
Q <- read_xlsx("C:/Users/Alberto/Desktop/AGRITECH/CHIANTI/ANALISI/ANALISI_TESI/qualità_2020.xlsx")
AZ <- Q[,3:12]
AZ <- na.omit(AZ)
...
AZ$`Qualità 2020`=as.numeric(AZ$`Qualità 2020`)
...
write.table(COR,file="C:/Users/Alberto/Desktop/AGRITECH/CHIANTI/ANALISI/ANALISI_TESI/Risultati/qualità_COR_2020.csv",
