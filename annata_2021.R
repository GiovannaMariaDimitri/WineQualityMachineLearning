...
RESA <- read_xlsx("C:/Users/Alberto/Desktop/AGRITECH/CHIANTI/ANALISI/ANALISI_TESI/annata_2021.xlsx")
...
corrplot(cor(PROD), type="lower",tl.cex=0.6, cl.cex = 0.6, cl.ratio = 0.1,
         tl.col='darkblue',number.digits=2, bg='lightblue')
plot(PROD)

write.table(COR,file="C:/Users/Alberto/Desktop/AGRITECH/CHIANTI/ANALISI/ANALISI_TESI/Risultati/annata_COR_2021.csv",
