...
Q <- read_xlsx("C:/Users/Alberto/Desktop/AGRITECH/CHIANTI/ANALISI/ANALISI_TESI/qualità_2018.xlsx")
AZ <- Q[,3:12]
AZ <- na.omit(AZ)
...
AZ$`Qualità 2018`=as.numeric(AZ$`Qualità 2018`)
...
write.table(COR,file="C:/Users/Alberto/Desktop/AGRITECH/CHIANTI/ANALISI/ANALISI_TESI/Risultati/qualità_COR_2018.csv",
