...
Q <- read_xlsx("C:/Users/Alberto/Desktop/AGRITECH/CHIANTI/ANALISI/ANALISI_TESI/qualità_2019.xlsx")
AZ <- Q[,3:12]
AZ <- na.omit(AZ)
...
AZ$`Qualità 2019`=as.numeric(AZ$`Qualità 2019`)
...
write.table(COR,file="C:/Users/Alberto/Desktop/AGRITECH/CHIANTI/ANALISI/ANALISI_TESI/Risultati/qualità_COR_2019.csv",
